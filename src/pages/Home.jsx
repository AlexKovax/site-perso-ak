...
function Home() {
  ...
  return (
    <>
      ...
      <Section title="Conférencier" variant="alt">
        <div className={styles.sectionContent}>
          <p className={styles.text}>
      ...
      {/* Section Praticien */}
      <Section title="Praticien du no-code et du vibe coding">
        <div className={styles.sectionContent}>
          <p className={styles.text}>
      ...
      {/* Section Livres */}
      <Section title="Livres" variant="alt">
        <div className={styles.sectionContent}>
          <p className={styles.text}>
      ...
      {/* Section Archives */}
      <Section title="Archives et autres projets">
        <div className={styles.sectionContent}>
          <p className={styles.text}>
